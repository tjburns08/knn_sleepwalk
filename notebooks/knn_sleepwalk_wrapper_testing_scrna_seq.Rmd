...
```{r run_knn_sleepwalk}
# Choose one
# Set dimr as mat as well
# KnnSleepwalk(mat = pca, embedding = list(tsne, umap), k = 27)
# KfnSleepwalk(mat = pca, embedding = list(tsne, umap), k = 27)
KnnSleepwalk(mat = hid, embedding = list(tsne, umap), k = 27)
# KfnSleepwalk(mat = hid, embedding = list(tsne, umap), k = 27)
```
